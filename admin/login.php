...
if (!empty($_POST)) {
  ...
  $password = md5($salt . mysqli_real_escape_string($db, $_POST['password']));
  ...
  if ($count == 1) {
    if (isset($_POST['check'])) {
      setcookie('username', $user, time() + (86400 * 30 * 40), "/");
      setcookie('cookie', $password, time() + (86400 * 30 * 40), "/");
    } else {
          ...
          <div class="card card-signin my-5" style="background-color: #535152;border-color:#fbb92f;">
            <div class="card-body">
              ...
              <form class="form-signin" method='POST'>
                ...
                <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" style="background-color: #535152;border-color:#fbb92f;color: #fbb92f;">Sign in</button>
                <hr class="my-4">
